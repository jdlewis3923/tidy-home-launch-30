// TIDY — Brevo template registry (edge-function mirror).
//
// Edge functions cannot import from src/, so this mirrors
// src/lib/emailTemplates.ts exactly. Keep the two in sync.
//
// No numeric template ID literals anywhere else. Never fall back to inline HTML.
