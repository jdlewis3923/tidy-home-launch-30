...
const ADDON_ROWS: CatalogRow[] = [
  ...
  // Lawn Care (5)
  { service_type: null, frequency: null, lookup_key: null, size: null, unit: 'one_time', quantity_rule: 'always_1', per_visit: false, is_addon: true, addon_name: 'hedge', stripe_price_id: 'price_1T1CpMD7AxvAjJGvWqNVcrSi', price_cents: 6500, description: 'Hedge & Bush Trimming', sort_order: 300 },
  ...
  { service_type: null, frequency: null, lookup_key: null, size: null, unit: 'one_time', quantity_rule: 'always_1', per_visit: false, is_addon: true, addon_name: 'fertilization', stripe_price_id: 'price_1TNCjqD7AxvAjJGvmWIM5yUB', price_cents: 7500, description: 'Fertilization Treatment', sort_order: 303 },
