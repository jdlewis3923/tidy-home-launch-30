        ...
        <div className="bg-primary/5 border border-primary/20 rounded-xl p-8 text-left mb-8">
          ...
          <ul className="space-y-4 text-sm text-text-mid">
            ...
            <li className="flex items-start gap-3">
              <span className="text-lg">📱</span>
              <span>
                <strong>Watch for a text from Tidy</strong> within 24 hours to confirm your spot and check your ZIP code
                availability.
              </span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>
                <strong>Once we launch in your area</strong>, you'll be among the first activated — with priority
                scheduling and locked pricing.
              </span>
            </li>
          </ul>
        </div>
