 ...
 *
 * `?lang=es` (the QR code on the Spanish panel) flips the existing site-wide
 * language toggle to Spanish on arrival; the param rides into signup so
 * English-panel and Spanish-panel scans can be told apart.
 */
const Neighbor = () => {
