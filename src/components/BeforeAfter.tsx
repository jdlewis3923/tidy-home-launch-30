  ...
  <section className="bg-background py-20 px-4">
    <div className="max-w-5xl mx-auto text-center">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="bg-destructive/5 border border-destructive/20 rounded-xl p-8 text-left">
        ...
        <div className="bg-success/5 border border-success/20 rounded-xl p-8 text-left">
