  ...
  return (
    <section className="bg-background py-20 px-4">
      <div className="max-w-5xl mx-auto text-center">
        <FadeIn>
          <span className="text-xs uppercase tracking-widest text-primary font-semibold">{t("The difference")}</span>
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mt-3 mb-12">{t("Life before and after Tidy")}</h2>
        </FadeIn>

        <div className="grid md:grid-cols-2 gap-6">
          <FadeIn delay={100}>
            <div className="bg-destructive/5 border border-destructive/20 rounded-xl p-8 text-left h-full">
              <h3 className="text-lg font-bold text-foreground mb-6">{t("❌ Before Tidy")}</h3>
          ...
          <FadeIn delay={200}>
            <div className="bg-success/5 border border-success/20 rounded-xl p-8 text-left h-full">
              <h3 className="text-lg font-bold text-foreground mb-6">{t("✅ With Tidy")}</h3>
              <ul className="space-y-4">
                {[
