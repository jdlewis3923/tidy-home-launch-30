  ...
  <section className="bg-background py-16 px-4">
    <div className="max-w-5xl mx-auto">
      <Reveal className="text-center mb-10">
        ...
        <h2 className="text-2xl md:text-3xl font-bold text-foreground mt-3">Three steps. Then never think about it.</h2>
      </Reveal>
            ...
            <Reveal key={s.title} delay={i * 80}>
              <div className="text-center md:text-left flex md:block items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-text-mid mt-1.5 leading-relaxed">{s.body}</p>
                </div>
              </div>
            </Reveal>
          );
