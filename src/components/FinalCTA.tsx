  ...
  return (
    <section className="bg-gradient-to-b from-navy to-primary-deep py-24 px-4 relative overflow-hidden">
      <div className="relative z-10 max-w-2xl mx-auto text-center flex flex-col items-center">
        ...
        <p className="text-primary-foreground/50 mb-8">{t("About 2 minutes · No contracts · Cancel anytime")}</p>

        <button id="cta-final" data-track="cta_final" onClick={() => { pushEvent("cta_click", { cta_id: "final_cta", cta_text: CUSTOMER_DASHBOARD_ENABLED ? "See your price — 60 seconds" : "Get Started" }); onOpenPopup(); }} className="bg-gold hover:bg-gold/90 text-gold-foreground font-bold text-lg px-10 py-4 rounded-xl transition-all hover:scale-105 shadow-[0_0_24px_rgba(245,197,24,0.4)] hover:shadow-[0_0_36px_rgba(245,197,24,0.6)] animate-pulse-gold">
          {t(CUSTOMER_DASHBOARD_ENABLED ? "See your price — 60 seconds →" : "Get Started — Request Early Access →")}
        </button>
